# Freshrss MCP Reference

This skill uses the Lab MCP integration for `freshrss`. The authoritative action catalog is live and should be discovered at call time.
